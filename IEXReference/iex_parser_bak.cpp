...
//     ifstream input_file;
//     // Log logger; -- will implement own logger later
...
//     }
//
//     // Function to check if a file is Zstandard-compressed
//     bool check_if_zst() {
//         std::ifstream file(filename, std::ios::binary);
//         if (!file.is_open()) {
//             std::cerr << "Error opening file: " << filename << std::endl;
...
//         file.close();
//
//         // Zstandard files start with the magic number 0x28B52FFD
//         return buffer[0] == '\x28' && buffer[1] == '\xB5' && buffer[2] == '\x2F' && buffer[3] == '\xFD';
//     }
//
...
//     // string iex_pcap_file_to_parse = "data_feeds_20241029_20241029_IEXTP1_DEEP1.0.pcap.gz";
//     // string iex_tops_pcap_file_to_parse = ""
//     string iex_pcap_file_to_parse = "data/ny4-iexg-tops-b-20230822T133000.pcap.zst";
//     string trades_output_file_name = "output/result.csv";
//     string symbols_of_interest_file = "ALL";
//
//
//     int max_packets_to_parse = 100;
//
//
//
//
//     // Instantiate and use parser
//     BasicPcapParser parser(iex_pcap_file_to_parse, trades_output_file_name,symbols_of_interest_file);
//
//     std::cout << "is gzip: "  << parser.check_if_gzip() << std::endl;
//     std::cout << "is zstt: " << parser.check_if_zst() << std::endl;
